...
public class project extends JFrame implements ActionListener {
    ...
    project(String atype, String meter) {
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/aa.jpg"));
        ...
        generatebill.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_S, ActionEvent.CTRL_MASK));
